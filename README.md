...
Backend REST API para loja virtual, feito com NestJS, Prisma e PostgreSQL. Com arquitetura modular, autenticação, autorização por roles, regras de negócio, testes, Swagger, seed demo e deploy.
